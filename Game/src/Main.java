...
public class Main extends Window
{
	...
	public void onInit()
	{
		...
		obj.setPosition(100, 0);
		obj.setSpriteName("dirt");
		objects.add(obj);
	}
	...
	public void onUpdate()
	{
		...
		if ((Keyboard.isKeyDown(Keyboard.KEY_A) || Keyboard.isKeyDown(Keyboard.KEY_D)
				|| Keyboard.isKeyDown(Keyboard.KEY_W) || Keyboard.isKeyDown(Keyboard.KEY_S)) && !person.getColliding())
		{
		...
		{
			if (person.getBounds().intersects(obj.getBounds())&&obj.getIsSolid())
			{
	...
	public void onRender()
	{
		for (Object obj : objects)
		{
			...
			GL11.glCallList(sprites.get(obj.getSpriteName()).getDisplayID());
			GL11.glPopMatrix();
		}
		...
		GL11.glCallList(sprites.get("guy").getDisplayID((int) person.getDisplayListCoords().getX(),
				(int) person.getDisplayListCoords().getY()));
