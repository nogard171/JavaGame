...
public class Entity extends Sprite
{
    ...
    org.lwjgl.util.Color defaultColor = new org.lwjgl.util.Color(1, 1, 1, 1);
	...
	if (topTexture != null)
	{
	    ...
	    GL11.glPushMatrix();
	    GL11.glTranslated(screenPosition.x - (topTexture.getTextureWidth() / 4),
		    (screenPosition.y - (topTexture.getTextureHeight() / 2) - 32), 0);
	    ...
	    GL11.glEnd();
	    GL11.glTranslatef(-screenPosition.x + (topTexture.getTextureWidth() / 4),
		    -screenPosition.y + (topTexture.getTextureHeight() / 2) + 32, 0);
	    GL11.glPopMatrix();
